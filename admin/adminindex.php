<?php
    ...
    $query = "SELECT * FROM articles WHERE file='' ORDER BY startdate DESC";
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="main_menu_iner">
                        ...
                        <span title="Circulars" class="menu-trigger visible-xs">
                            <span></span>
                            <span></span>
                            <b>Circulars</b>
                            <span></span>
                                ...
                                <div class="canven-menu-iner">
                                    <ul>                                        
                                        ...
                                        <?php foreach($departments as $department): ?>
                                            <li><a href="department.php?id=<?php echo $department['deptid'] ?>"><?php echo $department['deptname'] ?></a></li>
                                        <?php endforeach; ?>
                                        <li><a href="../circular/circular.php">All Circulars</a></li>
                                        <li><a href="manageDept.php">Manage Departments</a></li>
