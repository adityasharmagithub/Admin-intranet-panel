...
<body>
    <div class="container">
        <br>
        <a href="../admin/adminindex.php"><button class="btn btn-danger">Go to Home</button></a>
        <a href="../admin/jba.php"><button class="btn btn-primary">Information Technology</button></a>
        <a href="../admin/caa.php"><button class="btn btn-primary">Human Resources</button></a>
        <a href="../admin/cba.php"><button class="btn btn-primary">Corporate Communications</button></a>
                    ...
                    <?php foreach($circulars as $circular): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="view.php?id=<?php echo $circular['articleid']; ?>" target="_blank" class="view" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="View">&#xE417;</i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
